...
import {Navbar as NextNavbar, NavbarBrand, NavbarItem} from '@nextui-org/react';
        ...
        <div className = "p-2 lg:w-2/6 md:w-1/2 w-full -m-4 min-w-[500px] ">
          <div className = "overflow-hidden border border-t-4 border-blue-300 rounded-[15px] m-4 bg-white">
            ...
            <NextNavbar>
              <NavbarBrand>
              {/* <AcmeLogo /> */}
                <Link href={`/compiler/?filename=${props.file_name}`} className='flex items-center hover:text-blue-500'>
                            <p className="font-bold text-inherit pb-[1px] mr-2 max-w-[80px] overflow-scroll">{props.file_name}</p>
                            <MdOpenInFull />
                </Link>
              </NavbarBrand>
              <NavbarItem>
                  <div style={{alignSelf:"center"}} className='ml-[5vw] w-[fit-content] mt-[5px] mb-[5px]'>
                    ...
                    <>
                    <Button onPress={onRenameOpen} size="sm" className='bg-sky-500'><CgRename size='25px'/></Button>
                    <Modal 
                      isOpen={isRenameOpen} 
                    ...
                    <>
                      <Button onPress={onDeleteOpen} size="sm" color="danger" className='mr-[4px] ml-[4px]'><MdDeleteOutline size='25px'/></Button>
                      <Modal 
                        isOpen={isDeleteOpen} 
                          ...
                          {(onClose) => (
                            <>
                              ...
                              <ModalFooter>
                                ...
                                <Button color="danger" onPress={onClose} onClick={()=>{
