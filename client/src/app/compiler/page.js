...
const Page = () => {
    ...
    return (
        <div className='w-[100vw] h-[100vh] bg-sky-100'>
            ...
            <Split minSize = {[500,100]} className="split max-w-[90vw] ml-auto mr-auto mt-2 outline-1 rounded-[20px] overflow-hidden h-[90vh]">
                <div style={{display:'flex', flexDirection:"column", gap:"5px", height: '100%'}} className="rounded-[20px] overflow-hidden">
                {/* <div className="rounded-[20px] overflow-hidden"> */}
                        <NextNavbar className='bg-blue-300'>
                            <NavbarBrand>
                            {/* <AcmeLogo /> */}
                            <p className="font-bold text-inherit pb-[1px]">{file_name+". js"}</p>
                            </NavbarBrand>
                            ...
                            <NavbarItem>
                                <div style={{alignSelf:"center"}} className='ml-[5vw] w-[fit-content] mt-[5px] mb-[5px]'>
                                    ...
                                    ><VscRunAll /></Button>
                                    <Button size='sm' onClick={() => Save(value,file_name,user_id)} className="content-center bg-emerald-500 ml-4 mr-4"><AiOutlineSave/></Button>
                                </div>
                            </NavbarItem>
                        </NextNavbar>
                ...
                <div style={{display:'flex', flexDirection:"column", gap:"5px", height: '100%'}} className="rounded-[20px] overflow-hidden">
                        ...
                        <div className='pt-[5px] bg-white overflow-auto h-[85vh] p-[10px] pb-[30px] pt-[5px]' ref={outputRef}>
                            {
                                output.split('\n').map((value,index)=>{
                                    return <p>{value}</p>
                                })
