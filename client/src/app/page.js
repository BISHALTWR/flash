            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full mb-20">
                        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Never read a bad book again</h1>
                        <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Books we recommend are based on reviews from lots of people. Don't trust the author who just wan't to sell, trust the internet.</p>
                    </div>
